      ...
      vertexBuffers: [
        {
          ...
          attributes: [
            ...
            { format: 'float32', offset: SIZEOF_FLOAT, shaderLocation: 1 },
          ],
        },
      ],
    };
...
g.test('check_out_of_bounds_condition_on_attribute_shader_location').fn(async t => {
  const vertexState = {
    vertexBuffers: [
      {
        arrayStride: 0,
        attributes: [{ format: 'float32', offset: 0, shaderLocation: MAX_VERTEX_ATTRIBUTES - 1 }],
      },
    ],
  };
...
g.test('check_multiple_of_4_bytes_constraint_on_offset').fn(async t => {
  const vertexState = {
    vertexBuffers: [
      {
        arrayStride: 0,
        attributes: [{ format: 'float32', offset: SIZEOF_FLOAT, shaderLocation: 0 }],
      },
    ],
  };
